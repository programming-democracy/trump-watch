var data = [
  {'date': '2017-01-19', 'actions': [
    {
      'desc': 'DT said that he would cut funding for the DOJ\'s Violence Against Women programs.',
    ...
    },
    {
      ...
      'sources': ['http://time.com/4637046/donald-trump-hhs-lgbt/']
    },
    {
      'desc': 'DT ordered the resumption of construction on the Dakota Access Pipeline, while the North Dakota state congress considers a bill that would legalize hitting and killing protestors with cars if they are on roadways.',
      'sources': ['https://www.nytimes.com/2017/01/24/us/politics/keystone-dakota-pipeline-trump.html']
    },
    {
      'desc': 'Trump threatens to send "the Feds" into Chicago to address crime.',
      'sources': [
        'https://www.washingtonpost.com/news/post-politics/wp/2017/01/24/trump-threatens-to-send-in-the-feds-to-address-chicago-carnage/',
        'http://www.chicagotribune.com/news/nationworld/ct-trump-sanctuary-city-crime-data-20170127-story.html'
      ]
    }
  ]}, {'date': '2017-01-25', 'actions': [
    {
      'desc': 'Trump issued an executive order to begin building a wall along the US-Mexico border',
      'sources': [
    ...
    {
      'desc': 'Trump threatened to strip federal funding from sanctuary cities.',
      'sources': [
        'https://www.bostonglobe.com/metro/2017/01/25/trump-slashes-federal-funding-sanctuary-cities/CEXMyIvNZXEgtDTOOoyn3N/story.html',
        'http://www.npr.org/sections/thetwo-way/2017/01/26/511899896/trumps-threatens-sanctuary-cities-with-loss-of-federal-funds',
        'http://www.latimes.com/politics/la-na-pol-sanctuary-legal-battle-20170127-story.html'
      ]
    },
    {
      'desc': 'Trump announces "major investigation" into voter fraud, despite lack of evidence.',
      'sources': [
        'https://www.nytimes.com/2017/01/25/us/politics/trump-voting-fraud-false-claim-investigation.html',
    ...
    {
      'desc': 'Trump claimed torture works, and that he was considering resuming banned methods and reopening CIA black sites.',
      'sources': [
        'http://www.businessinsider.com/trump-says-torture-absolutely-works-2017-1',
  ...
  ]}, {'date': '2017-01-26', 'actions': [
    {
      'desc': 'Trump announced his intention to fund border wall with a 20% import tax on Mexican goods.',
      'sources': [
        'http://www.cnn.com/2017/01/26/politics/donald-trump-mexico-import-tax-border-wall/',
        'http://www.forbes.com/sites/eriksherman/2017/01/26/americans-will-pay-for-trumps-wall-even-with-a-mexican-import-tax/'
      ]
    },
    {
      'desc': 'Bannon, Trump\'s chief strategist, labels the US media as "the opposition party."',
      'sources': [
        'https://www.nytimes.com/2017/01/26/business/media/stephen-bannon-trump-news-media.html',
        'http://www.usatoday.com/story/news/politics/2017/01/27/donald-trump-steve-bannon-the-brody-file-cbn-news/97151478/',
        'http://thehill.com/homenews/administration/316578-trump-blasts-media-as-opposition-party',

      ]
    },
    {
      'desc': 'Trump falsely claimed that murders in Philadelphia are increasing despite an actual decrease.',
      'sources': [
        'http://abcnews.go.com/Politics/philadelphia-mayor-slams-trumps-false-statements-citys-murder/story?id=45082725',
        'http://thehill.com/homenews/administration/316349-despite-trumps-claims-murders-in-philly-on-downward-slope'
      ]
    },
    {
      'desc': 'Trump pulled Obamacare ads and outreach in the final week of enrollment.',
      'sources': [
    ...
    {
      'desc': 'Trump accepts immediate resignation of senior State Department officials, leaving leadership holes.',
      'sources': [
    ...
    {
      'desc': 'In leaked audio, Pence promised investigation into national voting rolls in support of baseless fraud claims.',
      'sources': [
        'http://thehill.com/blogs/blog-briefing-room/news/316437-pence-in-leaked-audio-there-will-be-full-evaluation-on-voter',
        'https://www.theguardian.com/us-news/2017/jan/26/trump-administration-voter-fraud-investigation-mike-pence',
        'http://www.chicagotribune.com/news/nationworld/politics/ct-pence-republicans-voting-probe-20170127-story.html'
      ]
    }
  ]}, {'date': '2017-01-27', 'actions': [
    {
      'desc': 'Trump banned entry to people from 7 nations, including current American residents holding visas or greencards.',
      'sources': [
        ...
        'https://www.cnet.com/news/google-donald-trump-immigration-order-memo-workers-sundar-pichai/'
      ]
    },
    {
      'desc': 'Trump announced Christian immigrants will receive priority over Muslims.',
      'sources': [
        'http://abcnews.go.com/Politics/donald-trump-hell-give-christian-refugees-priority/story?id=45099271',
        'https://www.washingtonpost.com/news/fact-checker/wp/2017/01/28/trumps-claim-that-it-is-very-tough-for-christian-syrians-to-get-to-the-united-states/'
      ]
    },
    {
      'desc': 'Trump revealed to have pressured parks service to support his inauguration crowd size claims.',
      'sources': [
        'http://www.cnn.com/2017/01/26/politics/donald-trump-inauguration-crowd-size/',
  ...
  ]}, {'date': '2017-01-28', 'actions': [
    {
      'desc': 'Trump removed the Director of National Intelligence and chairman of the Joint Chiefs of Staff from the National Security Council.',
      'sources': [
        'http://www.wsj.com/articles/donald-trump-signs-order-to-revamp-national-security-council-1485641329'
      ]
    },
    {
      'desc': 'Federal judge issued an injunction against deporting arrivals from banned Muslim countries.',
      'sources': [
    ...
    {
      'desc': 'Chinese official says war with US under Trump\'s leadership is becoming a "practical reality."',
      'sources': [
  ...
  ]}, {'date': '2017-01-29', 'actions': [
    {
      'desc': 'Trump reiterated US entry ban and claimed the ban wasn\'t about religion, despite conflicting statements.',
      'sources': [
        'http://www.cnn.com/2017/01/29/politics/donald-trump-executive-order-statement/',
        'http://www.cnn.com/2017/01/29/opinions/what-trump-said-about-travel-ban-is-false-opinion-aslan/'
      ]
    },
    {
      'desc': 'US border patrol uses Facebook to examine political views of detained US visa and greencard holders.',
      'sources': [
